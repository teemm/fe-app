...
export default function ProductsPage() {
    ...
    const getPlaceholderImage = (category: string) => {
        const imageMap: { [key: string]: string } = {
            ...
            'Shirts': 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=300&h=200&fit=crop',
            ...
            <div className="container mx-auto px-4 py-8">
                <div className="mb-8">
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                        Discover our amazing collection of products ({sortedProducts.length} items)
                ...
                {sortedProducts.length === 0 && (selectedBrands.length > 0 || priceRange[0] > minPrice || priceRange[1] < maxPrice) && (
